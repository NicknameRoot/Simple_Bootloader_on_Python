# Simple_Python_Bootloader Version Alpha_1.0.0.1
...
you can see it on a separate website using this link [Link](https://nicknameroot.github.io/Simple_Python_Bootloader/)
